...
public class Bulb {
	...
	public boolean equals(Object obj) {
		...
		return that.macAddress[0] == macAddress[0]
				&& that.macAddress[1] == macAddress[1]
				&& that.macAddress[2] == macAddress[2]
				&& that.macAddress[3] == macAddress[3]
				&& that.macAddress[4] == macAddress[4]
				&& that.macAddress[5] == macAddress[5];
	}
